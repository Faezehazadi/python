...
image = cv2.imread("inputs/girl.jpg")
image_gray = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)

image_sticker_red = cv2.imread("inputs/sticker-red.png")
image_sticker_green = cv2.imread("inputs/sticker-green.png")
image_sticker_spongebob = cv2.imread("inputs/spongebob.jpg")
